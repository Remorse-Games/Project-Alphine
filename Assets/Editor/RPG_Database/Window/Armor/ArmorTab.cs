...
namespace Remorse.Tools.RPGDatabase.Window
{
    public class ArmorTab : BaseTab
    {
        ...
        public void OnRender(Rect position)
        {
            ...
            armorSizeTemp = EditorGUILayoutExt.IntField(0, 999, armorSizeTemp, GUILayout.Width(firstTabWidth), GUILayout.Height(position.height * .75f / 15 - 10));
            ...
            if (armorSize > 0)
            {
                armor[index].armorPrice = EditorGUILayoutExt.IntField(0, 999, armor[index].armorPrice, GUILayout.Width(generalBox.width / 4 - 2), GUILayout.Height(generalBox.height / 8 - 9));
            }
            else
            {
            ...
            if (armorSize > 0)
            { armor[index].armorAttack = EditorGUILayoutExt.IntField(0, 999, armor[index].armorAttack, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            ...
            if (armorSize > 0)
            { armor[index].armorDefense = EditorGUILayoutExt.IntField(0, 999, armor[index].armorDefense, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorMAttack = EditorGUILayoutExt.IntField(0, 999, armor[index].armorMAttack, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorMDefense = EditorGUILayoutExt.IntField(0, 999, armor[index].armorMDefense, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorAgility = EditorGUILayoutExt.IntField(0, 999, armor[index].armorAgility, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorLuck = EditorGUILayoutExt.IntField(0, 999, armor[index].armorLuck, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorMaxHP = EditorGUILayoutExt.IntField(0, 999, armor[index].armorMaxHP, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
            ...
            if (armorSize > 0)
            { armor[index].armorMaxMP = EditorGUILayoutExt.IntField(0, 999, armor[index].armorMaxMP, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            else
            { EditorGUILayoutExt.IntField(0, 999, -1, GUILayout.Width(parameterChangesBox.width / 4 - 5), GUILayout.Height(parameterChangesBox.height / 8 + 9)); }
            GUILayout.EndVertical();
